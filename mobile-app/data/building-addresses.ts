...
export const BUILDING_ADDRESSES: BuildingAddress[] = [
  ...
  makeBuilding('FG', 'Faubourg Ste-Catherine Building', '1610 Ste-Catherine St W, Montreal, QC'),
  makeBuilding('GA', 'Grey Nuns Annex', '1211-1215 St-Mathieu St, Montreal, QC'),
  makeBuilding('GM', 'Guy-De Maisonneuve Building', '1550 De Maisonneuve Blvd W, Montreal, QC'),
  makeBuilding('GN', 'Grey Nuns Building', '1190 Guy St, Montreal, QC', [
  ...
  makeBuilding('H', 'Henry F. Hall Building', '1455 De Maisonneuve Blvd W, Montreal, QC', [
    'Hall Building',
  ]),
  ...
  makeBuilding('SB', 'Samuel Bronfman Building', '1590 Docteur-Penfield Ave, Montreal, QC'),

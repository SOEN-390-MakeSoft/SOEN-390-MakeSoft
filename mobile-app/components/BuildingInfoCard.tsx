          ...
          <View style={styles.infoFooterRow}>
            ...
            <View style={styles.featureRow}>
              <View style={styles.featureIconWrap}>
                <MaterialIcons name="elevator" size={21} color={elevatorColor} />
              </View>
              <View style={styles.featureIconWrap}>
                <MaterialIcons name="accessible" size={21} color={accessColor} />
              </View>
              <View style={styles.featureIconWrap}>
                <MaterialIcons name="train" size={21} color={metroColor} />
              </View>
            </View>
          </View>

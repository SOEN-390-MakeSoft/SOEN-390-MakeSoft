...
export const SGW_BOUNDS: CampusBounds = {
  minLat: 45.492,
  maxLat: 45.5,
  minLng: -73.582,
  maxLng: -73.571,
};
export const LOYOLA_BOUNDS: CampusBounds = {
  minLat: 45.454,
  maxLat: 45.464,
  minLng: -73.647,
  maxLng: -73.633,
 ...
 */
export function getClosestCampusBorder(point: LatLng): {
  campus: CampusName;
 ...
 */
export function nearestPolygonVertex(reference: LatLng, polygon: readonly LatLng[]): LatLng {
